...
! function () {
    ...
    var a, t = function (e, s) {
        ...
        function d(e) {
            ...
            if (!(e.shiftKey || e.altKey || e.ctrlKey || e.metaKey || document.activeElement && document.activeElement.nodeName && ("input" === document.activeElement.nodeName.toLowerCase() || "textarea" === document.activeElement.nodeName.toLowerCase()))) {
                if (37 === a || 39 === a || 38 === a || 40 === a) {
                    ...
                    for (var l = [[o.left, o.top], [o.left + v.width, o.top], [o.left, o.top + v.height], [o.left + v.width, o.top + v.height]], d = 0; d < l.length; d++) {
                        var p = l[d];
            ...
            if (0 !== t) {
                if (v.params.mousewheelInvert && (t = -t), v.params.freeMode) {
                    var s = v.getWrapperTranslate() + t * v.params.mousewheelSensitivity,
                        i = v.isBeginning,
                        n = v.isEnd;
                    if (s >= v.minTranslate() && (s = v.minTranslate()), s <= v.maxTranslate() && (s = v.maxTranslate()), v.setWrapperTransition(0), v.setWrapperTranslate(s), v.updateProgress(), v.updateActiveIndex(), (!i && v.isBeginning || !n && v.isEnd) && v.updateClasses(), v.params.freeModeSticky && (clearTimeout(v.mousewheel.timeout), v.mousewheel.timeout = setTimeout(function () {
                            v.slideReset()
        ...
        s = s || {};
        for (var g in m)
            if ("undefined" == typeof s[g]) s[g] = m[g];
            else if ("object" == typeof s[g])
            for (var h in m[g]) "undefined" == typeof s[g][h] && (s[g][h] = m[g][h]);
        var v = this;
        if (v.params = s, v.classNames = [], "undefined" != typeof a && "undefined" != typeof Dom7 && (a = Dom7), ("undefined" != typeof a || (a = "undefined" == typeof Dom7 ? window.Dom7 || window.Zepto || window.jQuery : Dom7)) && (v.$ = a, v.container = a(e), 0 !== v.container.length)) {
            ...
            v.container[0].swiper = v, v.container.data("swiper", v), v.classNames.push("swiper-container-" + v.params.direction), v.params.freeMode && v.classNames.push("swiper-container-free-mode"), v.support.flexbox || (v.classNames.push("swiper-container-no-flexbox"), v.params.slidesPerColumn = 1), (v.params.parallax || v.params.watchSlidesVisibility) && (v.params.watchSlidesProgress = !0), ["cube", "coverflow"].indexOf(v.params.effect) >= 0 && (v.support.transforms3d ? (v.params.watchSlidesProgress = !0, v.classNames.push("swiper-container-3d")) : v.params.effect = "slide"), "slide" !== v.params.effect && v.classNames.push("swiper-container-" + v.params.effect), "cube" === v.params.effect && (v.params.resistanceRatio = 0, v.params.slidesPerView = 1, v.params.slidesPerColumn = 1, v.params.slidesPerGroup = 1, v.params.centeredSlides = !1, v.params.spaceBetween = 0, v.params.virtualTranslate = !0, v.params.setWrapperSize = !1), "fade" === v.params.effect && (v.params.slidesPerView = 1, v.params.slidesPerColumn = 1, v.params.slidesPerGroup = 1, v.params.watchSlidesProgress = !0, v.params.spaceBetween = 0, "undefined" == typeof f && (v.params.virtualTranslate = !0)), v.params.grabCursor && v.support.touch && (v.params.grabCursor = !1), v.wrapper = v.container.children("." + v.params.wrapperClass), v.params.pagination && (v.paginationContainer = a(v.params.pagination), v.params.paginationClickable && v.paginationContainer.addClass("swiper-pagination-clickable")), v.rtl = r() && ("rtl" === v.container[0].dir.toLowerCase() || "rtl" === v.container.css("direction")), v.rtl && v.classNames.push("swiper-container-rtl"), v.rtl && (v.wrongRTL = "-webkit-box" === v.wrapper.css("display")), v.params.slidesPerColumn > 1 && v.classNames.push("swiper-container-multirow"), v.device.android && v.classNames.push("swiper-container-android"), v.container.addClass(v.classNames.join(" ")), v.translate = 0, v.progress = 0, v.velocity = 0, v.lockSwipeToNext = function () {
                ...
                var l, d = v.params.slidesPerColumn,
                    p = o / d,
                    u = p - (v.params.slidesPerColumn * p - v.slides.length);
                for (e = 0; e < v.slides.length; e++) {
                    l = 0;
                    var c = v.slides.eq(e);
                    if (v.params.slidesPerColumn > 1) {
                        var m, f, g;
                        "column" === v.params.slidesPerColumnFill ? (f = Math.floor(e / d), g = e - f * d, (f > u || f === u && g === d - 1) && ++g >= d && (g = 0, f++), m = f + g * o / d, c.css({
                            "-webkit-box-ordinal-group": m,
                            "-moz-box-ordinal-group": m,
                            "-ms-flex-order": m,
                            "-webkit-order": m,
                            order: m
                        })) : (g = Math.floor(e / p), f = e - g * p), c.css({
                            "margin-top": 0 !== g && v.params.spaceBetween && v.params.spaceBetween + "px"
                ...
                if (!v.params.centeredSlides) {
                    ...
                    v.snapGrid = h, Math.floor(v.virtualSize - v.size) > Math.floor(v.snapGrid[v.snapGrid.length - 1]) && v.snapGrid.push(v.virtualSize - v.size)
                }
            ...
            var y, b, x, T, S, C, M, P, E, z = "input, select, textarea, button",
                I = Date.now(),
                k = [];
            ...
            if (v.onTouchStart = function (e) {
                        ...
                        if (!v.params.swipeHandler || o(e, v.params.swipeHandler)) {
                            ...
                            if (!(v.device.ios && v.params.iOSEdgeSwipeDetection && t <= v.params.iOSEdgeSwipeThreshold)) {
                                if (y = !0, b = !1, T = void 0, L = void 0, v.touches.startX = t, v.touches.startY = s, x = Date.now(), v.allowClick = !0, v.updateContainerSize(), v.swipeDirection = void 0, v.params.threshold > 0 && (M = !1), "touchstart" !== e.type) {
                                    var r = !0;
                                    a(e.target).is(z) && (r = !1), document.activeElement && a(document.activeElement).is(z) && document.activeElement.blur(), r && e.preventDefault()
                                }
                    ...
                    if (e.originalEvent && (e = e.originalEvent), !(D && "mousemove" === e.type || e.preventedByNestedSwiper)) {
                        ...
                        if (D && document.activeElement && e.target === document.activeElement && a(e.target).is(z)) return b = !0, void(v.allowClick = !1);
                    ...
                    if (e.originalEvent && (e = e.originalEvent), v.emit("onTouchEnd", v, e), y) {
                        ...
                        var t = Date.now(),
                            s = t - x;
                        if (v.allowClick && (v.updateClickedSlide(e), v.emit("onTap", v, e), 300 > s && t - I > 300 && (P && clearTimeout(P), P = setTimeout(function () {
                            ...
                            }, 300)), 300 > s && 300 > t - I && (P && clearTimeout(P), v.emit("onDoubleTap", v, e))), I = Date.now(), setTimeout(function () {
                                v && (v.allowClick = !0)
                        ...
                        if (r = v.params.followFinger ? v.rtl ? v.translate : -v.translate : -S, v.params.freeMode) {
                            ...
                            if (v.params.freeModeMomentum) {
                                ...
                                k.length = 0;
                                var d = 1e3 * v.params.freeModeMomentumRatio,
                                    p = v.velocity * d,
                                    u = v.translate + p;
                                v.rtl && (u = -u);
                                var c, m = !1,
                                    f = 20 * Math.abs(v.velocity) * v.params.freeModeMomentumBounceRatio;
                                if (u < v.maxTranslate()) v.params.freeModeMomentumBounce ? (u + v.maxTranslate() < -f && (u = v.maxTranslate() - f), c = v.maxTranslate(), m = !0, E = !0) : u = v.maxTranslate();
                                else if (u > v.minTranslate()) v.params.freeModeMomentumBounce ? (u - v.minTranslate() > f && (u = v.minTranslate() + f), c = v.minTranslate(), m = !0, E = !0) : u = v.minTranslate();
                                else if (v.params.freeModeSticky) {
                                    var g, h = 0;
                                    for (h = 0; h < v.snapGrid.length; h += 1)
                                        if (v.snapGrid[h] > -u) {
                                            g = h;
                                            break
                                        }
                                    u = Math.abs(v.snapGrid[g] - u) < Math.abs(v.snapGrid[g - 1] - u) || "next" === v.swipeDirection ? v.snapGrid[g] : v.snapGrid[g - 1], v.rtl || (u = -u)
                                }
                                if (0 !== v.velocity) d = v.rtl ? Math.abs((-u - v.translate) / v.velocity) : Math.abs((u - v.translate) / v.velocity);
                                else if (v.params.freeModeSticky) return void v.slideReset();
                                v.params.freeModeMomentumBounce && m ? (v.updateProgress(c), v.setWrapperTransition(d), v.setWrapperTranslate(u), v.onTransitionStart(), v.animating = !0, v.wrapper.transitionEnd(function () {
                                ...
                                })) : v.velocity ? (v.updateProgress(u), v.setWrapperTransition(d), v.setWrapperTranslate(u), v.onTransitionStart(), v.animating || (v.animating = !0, v.wrapper.transitionEnd(function () {
                                    v && v.onTransitionEnd()
                        ...
                        var z = (r - v.slidesGrid[T]) / M;
                        if (s > v.params.longSwipesMs) {
                            if (!v.params.longSwipes) return void v.slideTo(v.activeIndex);
                            "next" === v.swipeDirection && (z >= v.params.longSwipesRatio ? v.slideTo(T + v.params.slidesPerGroup) : v.slideTo(T)), "prev" === v.swipeDirection && (z > 1 - v.params.longSwipesRatio ? v.slideTo(T + v.params.slidesPerGroup) : v.slideTo(T))
                        } else {
                    ...
                    "undefined" == typeof e && (e = !0), v.lazy && v.lazy.onTransitionStart(), e && (v.emit("onTransitionStart", v), v.activeIndex !== v.previousIndex && (v.emit("onSlideChangeStart", v), v.animateReset(v), v.animate(v), v.headerAlt(v)))
                }, v.onTransitionEnd = function (e) {
                    v.animating = !1, v.setWrapperTransition(0), "undefined" == typeof e && (e = !0), v.lazy && v.lazy.onTransitionEnd(), e && (v.emit("onTransitionEnd", v), v.activeIndex !== v.previousIndex && (v.emit("onSlideChangeEnd", v), v.headerAlt(v))), v.params.hashnav && v.hashnav && v.hashnav.setHash()
                    ...
                    v.removeSlide(e)
                }, v.animate = function (e) {
                    var t = a(window).width();
                    a(e.slides[e.activeIndex]).find("[data-pages-animation=custom]").each(function () {
                        function e() {
                            return null != p.vlgAttr ? (null != p.vlgStart && null != p.vlgEnd && (l[p.vlgAttr] = [p.vlgStart, p.vlgEnd]), null != p.vlgDelay ? d.delay = p.vlgDelay : d.delay = 0, null != p.vlgDuration ? d.duration = p.vlgDuration : d.duration = 400, null != p.vlgEasing ? d.easing = p.vlgEasing : "", d.visibility = "visible", d.mobileHA = !0, o.velocity(l, d), !0) : !1
                        }

                        function s() {
                            return null != p.lgAttr ? (null != p.lgStart && null != p.lgEnd && (l[p.lgAttr] = [p.lgStart, p.lgEnd]), null != p.lgDelay ? d.delay = p.lgDelay : d.delay = 0, null != p.lgDuration ? d.duration = p.lgDuration : d.duration = 400, null != p.lgEasing ? d.easing = p.lgEasing : "", d.visibility = "visible", d.mobileHA = !0, o.velocity(l, d), !0) : !1
                        }

                        function r() {
                            return null != p.mdAttr ? (null != p.mdStart && null != p.mdEnd && (l[p.mdAttr] = [p.mdStart, p.mdEnd]), null != p.mdDelay ? d.delay = p.mdDelay : d.delay = 0, null != p.mdDuration ? d.duration = p.mdDuration : d.duration = 400, null != p.mdEasing ? d.easing = p.mdEasing : "", d.visibility = "visible", d.mobileHA = !0, o.velocity(l, d), !0) : !1
                        }

                        function i() {
                            return null != p.smAttr ? (null != p.smStart && null != p.smEnd && (l[p.smAttr] = [p.smStart, p.smEnd]), null != p.smDelay ? d.delay = p.smDelay : d.delay = 0, null != p.smDuration ? d.duration = p.smDuration : d.duration = 400, null != p.smEasing ? d.easing = p.smEasing : "", d.visibility = "visible", d.mobileHA = !0, o.velocity(l, d), !0) : !1
                        }

                        function n() {
                            null != p.attr && (null != p.start && null != p.end && (l[p.attr] = [p.start, p.end]), null != p.delay ? d.delay = p.delay : d.delay = 0, null != p.duration ? d.duration = p.duration : d.duration = 400, null != p.easing ? d.easing = p.easing : "", d.visibility = "visible", d.mobileHA = !0, o.velocity(l, d))
                        }
                        var o = a(this),
                            l = {},
                            d = {},
                            p = o.data();
                        t >= 1800 && (e() || n()), 1800 >= t && t > 1024 ? s() || n() : 1024 >= t && t > 768 ? r() || n() : 768 >= t && (i() || n())
                    }), a(e.slides[e.activeIndex]).find("[data-pages-animation=standard]").each(function () {
                        var e = a(this),
                            t = {},
                            s = e.data();
                        null != s.type && (null != s.delay ? t.delay = s.delay : t.delay = 0, null != s.duration ? t.duration = s.duration : t.duration = 400, null != s.stagger ? t.stagger = s.stagger : t.stagger = !1, null != s.drag ? t.drag = s.drag : t.drag = !1, t.visibility = "visible", t.mobileHA = !0, e.velocity(s.type, t))
                    })
                }, v.animateReset = function (e) {
                    var t = a(e.slides[e.previousIndex]).find("[data-pages-animation=custom], [data-pages-animation=standard]");
                    0 !== t.length && (t.stop(), t.velocity({
                        opacity: [0, 1]
                    }, {
                        duration: 300,
                        complete: function (e) {
                            a(e).removeAttr("style").css("visibility", "hidden")
                        }
                    }))
                }, v.headerAlt = function (e) {
                    null != a(e.slides[e.activeIndex]).attr("data-pages-header") ? a("[data-pages=header]").addClass("alternate") : a("[data-pages=header]").removeClass("alternate")
                }, v.effects = {
                    fade: {
                        ...
                        setTranslate: function () {
                            ...
                            for (var s = 0; s < v.slides.length; s++) {
                                ...
                                var l = Math.max(Math.min(i[0].progress, 1), -1),
                                    ...
                                    p = 0,
                                    u = 0;
                                s % 4 === 0 ? (d = 4 * -o * v.size, u = 0) : (s - 1) % 4 === 0 ? (d = 0, u = 4 * -o * v.size) : (s - 2) % 4 === 0 ? (d = v.size + 4 * o * v.size, u = v.size) : (s - 3) % 4 === 0 && (d = -v.size, u = 3 * v.size + 4 * v.size * o), v.rtl && (d = -d), r() || (p = d, d = 0);
                                var c = "rotateX(" + (r() ? 0 : -n) + "deg) rotateY(" + (r() ? n : 0) + "deg) translate3d(" + d + "px, " + p + "px, " + u + "px)";
                    ...
                    coverflow: {
                        setTranslate: function () {
                            for (var e = v.translate, t = r() ? -e + v.width / 2 : -e + v.height / 2, s = r() ? v.params.coverflow.rotate : -v.params.coverflow.rotate, i = v.params.coverflow.depth, n = 0, o = v.slides.length; o > n; n++) {
                                var l = v.slides.eq(n),
                                    d = v.slidesSizesGrid[n],
                                    p = l[0].swiperSlideOffset,
                                    u = (t - p - d / 2) / d * v.params.coverflow.modifier,
                                    c = r() ? s * u : 0,
                                    m = r() ? 0 : s * u,
                                    f = -i * Math.abs(u),
                                    g = r() ? 0 : v.params.coverflow.stretch * u,
                                    h = r() ? v.params.coverflow.stretch * u : 0;
                                Math.abs(h) < .001 && (h = 0), Math.abs(g) < .001 && (g = 0), Math.abs(f) < .001 && (f = 0), Math.abs(c) < .001 && (c = 0), Math.abs(m) < .001 && (m = 0);
                                var w = "translate3d(" + h + "px," + g + "px," + f + "px)  rotateX(" + m + "deg) rotateY(" + c + "deg)";
            ...
            v.disableMousewheelControl = function () {
                return v.mousewheel.event ? (v.container.off(v.mousewheel.event, p), !0) : !1
            }, v.enableMousewheelControl = function () {
                return v.mousewheel.event ? (v.container.on(v.mousewheel.event, p), !0) : !1
            }, v.parallax = {
                setTranslate: function () {
            ...
            for (var A in v.plugins) {
                var B = v.plugins[A](v, v.params[A]);
                B && v._plugins.push(B)
            }
